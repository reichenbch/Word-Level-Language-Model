...
parser.add_argument('--data', type=str, default='C:\\Users\\RISHAV\\Documents\\kaggle_days\\Word Level Language Model\\data\\wikitext-2', help='location of the data corpus')
